...
const variants = {
  ...
  secondary:
    "bg-white dark:bg-dark-800 border border-slate-300 dark:border-dark-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-dark-700 rounded-xl px-6 py-3",
  danger:
    "bg-white dark:bg-dark-800 border border-red-300 dark:border-red-700 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950 rounded-xl px-6 py-3",
  cta:
