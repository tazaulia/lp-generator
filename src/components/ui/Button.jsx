const variants = {
  ...
  secondary:
    "bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 rounded-xl px-6 py-3",
  danger:
    "bg-white border border-red-300 text-red-600 hover:bg-red-50 rounded-xl px-6 py-3",
  cta:
