...
interface ProcessedData {
  ...
  heroType: string;
  platform: string;
  additionalSectionsText: string;
  stickyLogic: string;
  themeText: string;
  heroTypeText: string;
  scarcityLogic: string;
}

function resolveCustom(value: string, customValue: string, sentinel: string): string {
  if (value === sentinel && customValue) return customValue;
  return value;
}

function deriveThemeText(theme: string): string {
  switch (theme) {
...
function deriveHeroText(heroType: string): string {
  switch (heroType) {
...
function deriveScarcityLogic(scarcityType: string): string {
...
export function processFormData(state: FormState): ProcessedData {
...
export function generatePrompt(d: ProcessedData): string {
